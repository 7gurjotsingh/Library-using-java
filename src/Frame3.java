...
public class Frame3 extends javax.swing.JInternalFrame {
    ...
    private void getDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getDataActionPerformed
        ...
        try{
            ...
            String my ="SELECT * FROM studentdata WHERE RollNo = '"+roll+"';";
            ResultSet rs = St.executeQuery(my);
            while(rs.next()){
                jTextField2.setText(rs.getString(2));
                book1.setText(rs.getString(3));
                book2.setText(rs.getString(4));
                book3.setText(rs.getString(5));
                book4.setText(rs.getString(6));
                book5.setText(rs.getString(7));
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
        ...
        try{
            ...
            String my ="UPDATE studentdata SET Book1 = '"+BoOk1+"',Book2 = '"+BoOk2+"',Book3 = '"+BoOk3+"',"
                    + "Book4 = '"+BoOk4+"',Book5 = '"+BoOk5+"' ,Issue = '"+date+"' WHERE RollNo = '"+roll+"';";
                    St.execute(my);        
        }
        catch(Exception e){
            System.out.println(e);
